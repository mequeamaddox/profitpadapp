                        ...
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                              ...
                              <FormField
                                ...
                                render={({ field }) => (
                                  <FormItem>
                                    ...
                                    <FormDescription>
                                      Your monthly revenue target for tracking business
                                      performance
                                    </FormDescription>
                                    <FormMessage />
                                  </FormItem>
                          ...
                          <Card>
                            <CardHeader>
                              ...
                              <CardDescription>
                                Configure sales tax settings for accurate tax reporting and
                                estimations
                              </CardDescription>
                            </CardHeader>
                              ...
                              <FormField
                                ...
                                render={({ field }) => (
                                  <FormItem>
                                    ...
                                    <FormDescription>
                                      Enter as decimal (e.g., 0.0825 for 8.25% tax rate).
                                      This will be used for tax calculations and
                                      estimations.
                                    </FormDescription>
                                    <FormMessage />
                                  </FormItem>
                              ...
                              <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
                                ...
                                <div className="space-y-1 text-sm text-blue-800">
                                  {form.watch("taxInclusiveSales") ? (
                                    <>
                                      <p>
                                        <strong>Tax-Inclusive:</strong> $100 sale = $
                                        {(
                                          100 /
                                          (1 + (parseFloat(form.watch("salesTaxRate")) || 0))
                                        ).toFixed(2)}{" "}
                                        base + $
                                        {(
                                          100 -
                                          100 /
                                            (1 +
                                              (parseFloat(form.watch("salesTaxRate")) || 0))
                                        ).toFixed(2)}{" "}
                                        tax
                                      </p>
                                      <p className="text-xs">
                                        Tax is already included in your sale price
                                      </p>
                                    </>
                                  ) : (
                                    <>
                                      <p>
                                        <strong>Tax-Exclusive:</strong> $100 base + $
                                        {(
                                          100 *
                                          (parseFloat(form.watch("salesTaxRate")) || 0)
                                        ).toFixed(2)}{" "}
                                      ...
                                      <p className="text-xs">
                                        Tax is added on top of your sale price
                                      </p>
                                    </>
                                  )}
                                </div>
